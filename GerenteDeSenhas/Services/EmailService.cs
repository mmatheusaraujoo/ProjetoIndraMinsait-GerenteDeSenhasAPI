...
namespace GerenteDeSenhas.Services
{
    public class EmailService
    {
        ...
        internal void EnviarEmail(string[] destinatario,string assunto,Guid usuarioId,string codigoDeAtivacao)
        {
            Mensagem mensagem = new Mensagem(destinatario,assunto,
...

        {
            ...
            mensagemDeEmail.From.Add(new MailboxAddress("Gerente de Senha Api",
                _configuration.GetValue<string>("EmailSettings:From")));
